...
set(stdout_log "/home/sl33n/repository/test_secp256k1/libs/src/secp256k1-stamp/secp256k1-install-out.log")
set(stderr_log "/home/sl33n/repository/test_secp256k1/libs/src/secp256k1-stamp/secp256k1-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/sl33n/repository/test_secp256k1/libs/src/secp256k1-stamp/secp256k1-install-*.log")
  endif()
  ...
  set(msg "secp256k1 install command succeeded.  See also /home/sl33n/repository/test_secp256k1/libs/src/secp256k1-stamp/secp256k1-install-*.log")
  message(STATUS "${msg}")
endif()
